...
@section('content')
                    ...
                    <div class="col-md-6">
                        <div class="card card-animate">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <p class="fw-medium text-muted mb-0">Appointments</p>
                                        <h2 class="mt-4 ff-secondary fw-semibold"><span
                            ...
                            <div class="table-responsive table-card mt-3">
                                <table
                                    ...
                                    <thead
                                        ...
                                        <tr>
                                            <th>Duration (Secs)</th>
                                            <th style="width: 30%;">Appointments</th>
    ...
    <div class="row">
        ...
        <div class="col-xl-6">
            <div class="card card-height-100">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Audiences Appointments by Country</h4>
                    <div class="flex-shrink-0">
